namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyFreedomUIEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("edd0d4fe-09c1-4817-888e-b4dbb608197f");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("0ad7a45c-bc6b-6b11-f263-37bc5a048997"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("15b617c3-e473-4cbd-82ea-9a014ae25fb3"),
				CreatedInSchemaUId = new Guid("edd0d4fe-09c1-4817-888e-b4dbb608197f"),
				ModifiedInSchemaUId = new Guid("edd0d4fe-09c1-4817-888e-b4dbb608197f")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("edd0d4fe-09c1-4817-888e-b4dbb608197f"));
		}
